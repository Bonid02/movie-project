...
# Set default encoding to be able to hand utf-8
# characters sent by the api response
reload(sys)
sys.setdefaultencoding('utf-8')
# List of movies to search
movie_list = ["Pacific Rim", "Interstellar", "Schindler's List",
              "Lord Of The Rings Fellowship Of The Ring",
              "The Matrix", "Father Of Lights"]
movies_arr = []
...
def movie_api(movie_name):
    ...
    url_get = "https://api.themoviedb.org/3/search/movie?api_key="
    response1 = requests.get(url_get + api_key + "&query=" + movie_name)
    ...
    # Instantiate the Movie() to create object
...
# Call fresh_tomatoes.py file and call open_movies_page()
# to pass the movies_arr list
